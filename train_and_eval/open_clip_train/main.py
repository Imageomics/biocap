...
def main(args):
    ...
    if args.distributed and not args.horovod:
        ...
        # Add find_unused_parameters=True for dual-projector model
        # This is needed because in each batch we only use one set of projectors
        # (either tax or caption) based on the randomly selected text type
